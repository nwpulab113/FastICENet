...
river_palette = [128, 128, 128, 128, 0, 0, 192, 192, 128]

zero_pad = 256 * 3 - len(river_palette)
for i in range(zero_pad):
    river_palette.append(0)
...
def river_colorize_mask(mask):
    # mask: numpy array of the mask
    new_mask = Image.fromarray(mask.astype(np.uint8)).convert('P')
    new_mask.putpalette(river_palette)
