...
class CriterionICNet(nn.Module):
    ...
    def __init__(self, weight=None, ignore_label=255, thresh=0.7, min_kept=100000, reduce=True):
        super(CriterionICNet, self).__init__()
        self.ignore_label = ignore_label
        self.criterion1 = CrossEntropyLoss2d(weight=weight, ignore_label=self.ignore_label)
...
class ProbOhemCrossEntropy2d(nn.Module):
    def __init__(self, ignore_label=255, reduction='mean', thresh=0.6, min_kept=256,
        ...
        if use_weight:
            ...
            weight = torch.FloatTensor([3.6161606, 3.4025493, 2.0219433])
