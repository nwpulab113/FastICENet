...
def parse_args():
    ...
    parser.add_argument('--model', default="BiseNet", help="model name: (default ENet)")
    parser.add_argument('--dataset', default="river", help="dataset: cityscapes or camvid")
    parser.add_argument('--num_workers', type=int, default=1, help="the number of parallel threads")
    parser.add_argument('--batch_size', type=int, default=1,
                        help=" the batch_size is set to 1 when evaluating or testing")
    parser.add_argument('--checkpoint', type=str,default="./model_1135.pth",
    ...
    # Get the best test result among the last 10 model records.
        ...
        if args.checkpoint:
            if os.path.isfile(args.checkpoint):
                ...
                index = list(range(epoch - 299, epoch + 1))[np.argmax(mIOU_val)]
