...
def parse_args():
    ...
    # model and dataset
    parser.add_argument('--model', type=str, default="FastICENet", help="model name: (default ENet)")
    ...
    parser.add_argument('--savedir', default="./runBiseNetOCR/", help="directory to save the model snapshot")
...
def train_model(args):
    ...
    elif args.dataset == 'river' and args.use_ohem:
        print("ohem")
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        if args.dataset == 'camvid':
            ...
            if (epoch > 200 and epoch % 10 == 0) or epoch > 900:
                torch.save(state, model_file_name)
